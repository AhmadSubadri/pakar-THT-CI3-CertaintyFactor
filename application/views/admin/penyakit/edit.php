    ...
    <div class="col-lg-12 d-flex align-items-strech">
        <div class="card w-100">
            <div class="card-body">
                ...
                <form action="<?= site_url('penyakit/ubah/' . $data->id_penyakit); ?>" method="post">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Kode Penyakit</label>
                                <input type="text" placeholder="Kode Penyakit *" value="<?= $data->kode_penyakit; ?>" class="form-control" name="kode_penyakit" id="exampleInputEmail1" aria-describedby="emailHelp" />
